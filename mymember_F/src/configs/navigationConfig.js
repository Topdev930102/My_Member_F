  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: <PersonIcon style={{ fontSize: "1.5em" }} className="ml-1" />,
        permissions: ["admin", "editor"],
        navLink: "/app/student/demo-table/list",
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        permissions: ["admin", "editor"],
        navLink: "/calendar-new",
      },
      // {
        // role: 0,
        // id: "nested52",
        // title: "Latest Calendar",
        // icon: <CalendarTodayIcon fontSize="medium" className="ml-1" />,
        // permissions: ["admin", "editor"],
        // navLink: "/latest-calendar",
      // },
      // {
        // role: 0,
        // id: "nested53",
...
const AdminNavigationConfig = [
  ...
  },
  {
    ...
    id: 0,
    title: "Clients",
    icon: <GroupsIcon style={{ fontSize: "1.5em" }} />,
...
const SubUserAccess = () => {
  ...
  if (roleList !== undefined) {
    ...
    let result = SchoolNavigationConfig.filter((v) =>
      Object.keys(justStrings).includes(v.type)
    );
    return result;
  } else {
