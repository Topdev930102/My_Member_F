...
const Editemplyee = lazy(() => import("./views/pages/employee/Editemplyee"));
...
const DemoGetData = lazy(() => import("./views/apps/user/list/DemoGetData"));
...
const Employee = lazy(() => import("./views/pages/employee/Employeesidebar"));
...
const calendarNew = lazy(() => import("./views/apps/calendar1/index"));
// const latestCalendar = lazy(() => import("./views/apps/calendar1/LatestCalendar/index"));
// const calendar = lazy(() => import("./views/apps/calendar/Calendar.js"));
...
const TicketView = lazy(() => import("./views/pages/marketing/ticket"));

const TicketDetail = lazy(() =>
  import("./views/pages/marketing/ticket/detail")
);

const LiveChat = lazy(() => import("./views/pages/marketing/livechat/Chat"));

// chatbot component
const ChatbotDetails = lazy(() =>
  import("./views/pages/marketing/v2test/chatbot")
);
...
const PageConnect = lazy(() =>
  import(
    "./views/pages/marketing/socialmediamarketing/workspaceform/PageConnect"
  )
);

const sharewithme = lazy(() =>
  import("./views/pages/documents/components/ShareWithMe")
);
const trash = lazy(() => import("./views/pages/documents/components/Trash"));
const support = lazy(() =>
...
const Reputation = lazy(() =>
  import("./views/pages/marketing/Raputation/ReputationSideBar")
);
const SocialMediaConnecting = lazy(() =>
  import("./views/pages/marketing/socialmediamarketing/SocialMediaConnecting")
);
const WorkSpace = lazy(() =>
  import(
    "./views/pages/marketing/socialmediamarketing/WorkSpace_components/WorkSpace"
  )
);
...
const CreateEvent = lazy(() =>
  import(
    "./views/pages/mySchool/Testing/Eligiblev2/CreateEventForms/CreateEventStepper"
  )
);
...
const forgotPassword = lazy(() =>
  import("./views/pages/authentication/resetPassword/ForgotPassword")
);
...
// Form Builder
const formBuilderIndex = lazy(() => import("./views/formbuilder/pages/Index"));
const formBuilderCreate = lazy(() =>
  import("./views/formbuilder/pages/Create")
);
const formBuilderCreateTemplate = lazy(() =>
  import("./views/formbuilder/pages/CreateTemplateStepper")
);
const formBuilderLayout = lazy(() =>
  import("./views/formbuilder/pages/Chooselayout")
);
const formBuilderHome = lazy(() => import("./views/formbuilder/pages/home"));
const formBuilderView = lazy(() => import("./views/formbuilder/pages/view"));
const formBuilderPreView = lazy(() =>
  import("./views/formbuilder/pages/preview")
);
    ...
    return (
      ...
      <BrowserRouter history={history}>
        <Switch>
          ...
          />
          <AppRoute exact path="/calendar-new" component={calendarNew} />
          {/* <AppRoute exact path="/latest-calendar" component={latestCalendar} /> */}
          ...
          <AppRoute
            ...
            component={ShopAddMembership}
          />
          <AppRoute path="/admin/dashboard" component={Admindashboard} />
          ...
          />
          <AppRoute
            path="/app/ticket/ticketview/overview/:ticketStatus"
            component={TicketView}
          />
          <AppRoute
            path="/app/ticket/ticketview/:ticketId"
          ...
          <AppRoute exact path="/app/employee" component={Employee} />
          <AppRoute exact path="/app/my-employee/:actionType/:id" component={Editemplyee} />
          <AppRoute
            exact
            path="/app/my-employee/:actionType/:id"
            component={Editemplyee}
          />
          ...
          />
          <AppRoute
            path="/company/marketing/socialmedia"
            component={PageConnect}
          />
          <AppRoute
            path="/company/documenets/sharewithme"
            component={sharewithme}
          />
          <AppRoute path="/company/documents/trash" component={trash} />
          ...
          <AppRoute
            exact
            path="/app/marketing/reputation"
            component={Reputation}
          />
          <AppRoute
            exact
            path="/app/marketing/social-media-connecting"
            component={SocialMediaConnecting}
          />
          <AppRoute
            exact
            path="/app/marketing/social-media-connecting/:type"
            component={WorkSpace}
          />
          <AppRoute
          ...
          <AppRoute
            path="/app/student/demo-table/list"
            component={DemoGetData}
          />
          <AppRoute path="/app/demo-data/list" component={memberList} />
          <AppRoute
          ...
          <AppRoute
            path="/app/document/document-tutorial"
            component={DocumentTutorial}
          />
          ...
          <AppRoute
            path="/builder/template/create"
            component={formBuilderCreateTemplate}
          />
          <AppRoute
            path="/builder/template/view/:id"
            component={formBuilderCreateTemplate}
          />
          <AppRoute path="/builder/layout" component={formBuilderLayout} />
          <AppRoute path="/builder/home/:id" component={formBuilderHome} />
          <AppRoute
            path="/builder/view/:id/:userId"
