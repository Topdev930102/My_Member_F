          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              <p className="p-heading">
                CMA Planner offers packages for any stage of business. Whether
                it be startup or multi-level franchise systems we can help.
              </p>
            </div>
            {/* <!-- end of col --> */}
          </div>
                ...
                <div className="card-body">
                  ...
                  <ul className="list-unstyled li-space-lg">
                    <li className="media">
                      ...
                      <div className="media-body">Core Bussiness Systems</div>
                    </li>
                    <li className="media">
                      <FontAwesomeIcon className="fontAweosme" icon={faCheck} />
                      <div className="media-body">Under 100 Contacts</div>
                    </li>
                    <li className="media">
                      <FontAwesomeIcon className="fontAweosme" icon={faCheck} />
                      <div className="media-body">Biling</div>
                    </li>
                    <li className="media">
                      <FontAwesomeIcon className="fontAweosme" icon={faCheck} />
                      <div className="media-body">Custom Features</div>
                    </li>
                  </ul>
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <ul className="list-unstyled li-space-lg">
                    <li className="media">
                      <FontAwesomeIcon className="fontAweosme" icon={faCheck} />
                      <div className="media-body">Core Bussiness System</div>
                    </li>
                    <li className="media">
                      <FontAwesomeIcon className="fontAweosme" icon={faCheck} />
                      <div className="media-body">Under 100 Contacts</div>
