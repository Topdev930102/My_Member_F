...
const Rowadvnace = (props) => {
  ...
  const handleMarginChange = (value, newVal) => {
    let attributes = getSelectedHtmlElement().getAttributes();
    attributes.margin = newVal;
    getSelectedHtmlElement().setAttributes(attributes);
    getSelectedHtmlElement().addStyle({ 'margin-top': newVal })
  }
    ...
    <div id="rowAdvance">
      <div className='py-0'>
        <div className='inputwarrper'>
          ...
          <Select style={{ width: 250, height: 42}} defaultValue={cornerRadius} onChange={handleCornerRadiusChange} getPopupContainer={() => document.getElementById('rowAdvance')}>
          ...
          cornerRadius > 0?
            (
              <div className='inputwarrper'>
                ...
                <Select defaultValue={cornerRadiusType} style={{ width: 250, height: 42}} onChange={handleCornerEdgeChange} getPopupContainer={() => document.getElementById('rowAdvance')}>
      ...
      <div className='inputwarrper'>
        ...
        <Select style={{ width: 250, height: 42}} defaultValue={border} onChange={handleBorderChange} getPopupContainer={() => document.getElementById('rowAdvance')}>
        ...
        border !== "none" ? (
          <>
            <div className='inputwarrper'>
              ...
              <Select defaultValue={borderStyle} style={{ width: 250, height: 42}} onChange={handleBorderStyleChange} getPopupContainer={() => document.getElementById('rowAdvance')}>
            ...
            <div className='inputwarrper'>
              ...
              <Select defaultValue={borderSize} style={{ width: 250, height: 42}} onChange={handleBorderSizeChange} getPopupContainer={() => document.getElementById('rowAdvance')}>
      ...
      <div className='inputwarrper'>
        ...
        <Select style={{ width: 250, height: 42}}  getPopupContainer={() => document.getElementById('rowAdvance')}>
      ...
      <div className='sliderinputwarrper'>
        ...
        >
          ...
          >Side Margin</Typography>
        </div>
        <Slider  onChange={handleMarginChange}
                 size="small"
                 defaultValue={getSelectedHtmlElement().getAttributes().margin}
                 valueLabelDisplay="auto" />
        <div style={{width: 72}}
        >
          <Input className='countinput' disabled={true} value={getSelectedHtmlElement().getAttributes().margin} />
        </div>
