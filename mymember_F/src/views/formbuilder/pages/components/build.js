...
import billingType from "../../elements/billing/billing";
//SURVEY ELEMENTS
...
import {UPDATE_FORM_DATA} from "../../../../redux/actions/form-builder";
...
const Build = (props) => {
  ...
  const formBuilder = editor => {
    ...
    editor.DomComponents.addType('mym_text_box', new FillableElement(fullText, 'text_box', 'text').getElement())
  ...
  const saveEditor = () => {
    if (editor) {
      ...
      UPDATE_FORM_DATA(formId, html, css, js, JSON.stringify(data));
  ...
  return (
    <>
                ...
                >
                  <Box sx={{
                    ...
                    <TabList onChange={handleCh} aria-label="side-menu-tabs" >
                      ...
                      <Tab label="Merge" value="3" sx={{ color: '#AAAAAA' }} />
                    </TabList>
                  </Box>
              ...
              <Box sx={{
                ...
                >
                  ...
                  >
                    ...
                    {console.log(editor?.getSelected(),"editoreditoreditor")}
      ...
      <Prompt when={contentChange} message="Changes you made may not be saved. Are you sure you want to leave?" />
    </>
  )
