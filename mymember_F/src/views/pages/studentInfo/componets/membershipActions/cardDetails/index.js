...
import { FormGroup, Input, Label, Col, Row, CustomInput } from "reactstrap";
...
import PaymentMethods from "../../../../stripePayments/paymentMethods";
...
const CardDetails = (props) => {
  ...
  return (
    <>
      <TabContext value={isExistingCard}>
        <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
          <TabList onChange={handleTabChange} aria-label="lab API tabs example">
            <Tab label="New Card" value="newCard" />
            <Tab label="Pay with Saved Cards" value="existingCard" />
          </TabList>
        </Box>
        <TabPanel value="newCard" sx={{ width: "100%" }}>
          <Row>
            <Col sm="4" md="4">
              <FormGroup>
                <Label>Email</Label>
