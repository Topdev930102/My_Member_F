  ...
  return (
    ...
    >
      <div className="login-section pt-0">
        ...
        <Typography className="note" color="textSecondary" component="span">
        ...
        <div className="content-center w-100">
          <Button
            type="submit"
            disabled={String(otp).length === 6 ? false : true}
            className={`${classes.otpVerify} content-center w-100`}
          >
            {loading ? (
              <CircularProgress
        ...
        >
          <Typography color="textSecondary" component="span">
            Don’t receive the OTP?<span className="ml-1 mr-1">{otpTimer}</span>
          </Typography>
          <Button
            size="small"
            className={`${classes.buletext} p-0`}
            onClick={resendOtp}
            disabled={otpTimer !== 0}
          >
            Resend OTP
...
export default connect(null, { SEND_OTP, SEND_OTP_FOR_EMAILVERIFICATION })(
  Otpverification
);
