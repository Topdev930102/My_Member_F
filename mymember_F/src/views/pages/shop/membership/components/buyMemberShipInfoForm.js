...
const BuyMemberShipInfoForm = (props) => {
  ...
  const [selectedDocumentType, setSelectedDocumentType] = useState(memberShipDetail?.docType)
  ...
  return (
    <div style={{ width: "100%" }}>
      <Row>
        ...
        {selectedDocumentType === "Digital" && (
          <Col sm="3" md="3" lg="3">
            <FormGroup className="form-label-group">
              <div>
                <Label for="formbuilderdata">Select One</Label>
              </div>
              <CustomInput type="select" name="docType" id="docType">
                {props.uforms?.memberdata?.map((data) => {
...
export default connect(mapStateToProps, { GET_FUNNEL })(BuyMemberShipInfoForm);
