...
const AddNewTicketModal = (props) => {
  ...
  const [reqNameState, setReqNameState] = useState("");
  const [reqEmailState, setReqEmailState] = useState("");
  ...
  useEffect(() => {
    setReqEmailState(props.userInfo?.email);
    setReqNameState(props.userInfo?.username);
  ...
  const handleOk = async () => {
    ...
    const newTicket = await add_new_ticket({
        ...
        ticketName,
        reqEmail: reqEmailState,
        reqName: reqNameState,
        status: 'Open',
        priority,
        messages: [
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            <Input value={reqNameState} onChange={(e) => setReqNameState(e.target.value)}/>
          </div>
        </Form.Item>
        <Form.Item
        ...
        >
          <div>
            <Input value={reqEmailState} onChange={(e) => setReqEmailState(e.target.value)}/>
          </div>
        </Form.Item>
