      ...
      >
        ...
        {lgMatch && customers.length > 0 ? (
          ...
          >
              ...
              >
                {studentId !== "" ? (
                  ...
                  <div>
                    ...
                    <a
                      onClick={(e) =>
                        // history.push("/data-list/add-new-student/")
            ...
            <Dialog
              open={isAddNewMemberModalOpen}
              onClose={(e) => setIsAddNewMemberModalOpen(false)}
              maxWidth="md"
            >
              ...
              <DialogContent>
                <Box sx={{width: '400px'}}>
                  <FormGroup>
                    <FormControlLabel
                      control={
                        <Checkbox checked={addmemebrtype === "Active Member"} />
                      }
                      onChange={() => setaddmemebrtype("Active Member")}
                      label="Active Member"
                    />
                    <FormControlLabel
                      control={
                        <Checkbox checked={addmemebrtype === "Active Trial"} />
                      }
                      onChange={() => setaddmemebrtype("Active Trial")}
                      label="Active Trial"
                    />
                    <FormControlLabel
                      control={<Checkbox checked={addmemebrtype === "Leads"} />}
                      onChange={() => setaddmemebrtype("Leads")}
                      label="Leads"
                    />
                    <FormControlLabel
                      control={
                        <Checkbox checked={addmemebrtype === "Former Member"} />
                      }
                      onChange={() => setaddmemebrtype("Former Member")}
                      label="Former Member"
                    />
                    <FormControlLabel
                      control={
                        <Checkbox checked={addmemebrtype === "Former Trial"} />
                      }
                      onChange={() => setaddmemebrtype("Former Trial")}
                      label="Former Trial"
                    />
                  </FormGroup>
                </Box>
              ...
              <DialogActions>
                <div className="d-flex justify-content-end">
                  <Button variant="contained" onClick={(e) => handleAddNewMember()}>Add</Button>
                </div>
              </DialogActions>
            </Dialog>
          </div>
