...
import NonMemberMain from './components/NonMemberMain';
    ...
    return (
        <>
            ...
            <Row className="app-user-list">
                <Col md="3">
                    <Card>
                        <div style={{ display: "inline-grid" }}>
                            <div
                                className={`d-flex align-items-center tab_guest ${Tabsvalue === 0
                                    ? "bgActive"
                                    : ""
                                    }`}
                                onClick={() => {
                            ...
                            <div
                                className={`d-flex align-items-center tab_guest ${Tabsvalue === 1
                                    ? "bgActive"
                                    : ""
                                    }`}
                                onClick={() => {
                            ...
                            <div
                                className={`d-flex align-items-center tab_guest ${Tabsvalue === 2
                                    ? "bgActive"
                                    : ""
                                    }`}
                                onClick={() => {
                            ...
                            <div
                                className={`d-flex align-items-center tab_guest ${Tabsvalue === 3
                                    ? "bgActive"
                                    : ""
                                    }`}
                                onClick={() => {
                            ...
                            <div className={`d-flex align-items-center tab_guest ${Tabsvalue === 4
                                ? "bgActive"
                                : ""
                                }`
                            }
                            ...
                            >
                                ...
                                <div
                                    className={`d-flex align-items-center tab_guest ${Tabsvalue === 5
                                        ? "bgActive"
                                        : ""
                                        }`
                                    }
                ...
                <Col md="9">
                    {
                        Tabsvalue === 0 ? (<ActiveMemberTable />)
                            : Tabsvalue === 1 ? (<FormalMemberTable />)
                                : Tabsvalue === 2 ? (<ActiveTrialsTable />)
                                    : Tabsvalue === 3 ? (<FormalTrialTable />)
                                        : Tabsvalue === 4 ? (<LeadMembersTable />)
                                            : (<NonMemberMain />)
                    }
                </Col>
            </Row>
