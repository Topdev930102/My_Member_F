    ...
    return (
        <>
            ...
            <div className="row stepperSection">
                            ...
                            return (
                                <Step {...stepProps} className="column" key={index}>
                                    <StepLabel className="d-flex justify-content-between align-items-start stepsLabel">
                                        <div className="d-flex align-items-center" style={{cursor: activeStep >= index ? 'pointer' : 'not-allowed'}} onClick={(e)=> {
                ...
                <div className="col-12 col-md-9 mt-1 mt-sm-0">
                    <Card >
                            ...
                            <div className="p-1 stepperCard" >
                                <FormProvider {...methods}>
                                    <form onSubmit={methods.handleSubmit(handleNext)}>
                                        ...
                                        <div
                                            className="d-flex justify-content-between col-md-10 ml-sm-3"

                                        >
                                            <Button
                                                disabled={activeStep === 0}
                                                className={`px-2 ${activeStep ? getSteps : "d-none"} ml-sm-4`}
                                                style={{
                                                    color: "#40a7e1",
                                                    height: 40,
                                                    borderRadius: "4px",
