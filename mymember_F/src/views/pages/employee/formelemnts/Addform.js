      ...
      <Card className="d-flex justify-content-center">
        <Box sx={{ width: "500px", padding: "10px" }}>
          ...
          {activeStep === 1 && (
            <div className="m-1">
              {selected === "Documents" && (
                <Documents setOpen={setOpen} roleName={roleName} goBack={goBack} handleNext={handleNext} />
              )}{" "}
              {selected === "Digital" && (
                <Digitalforms setOpen={setOpen} roleName={roleName} goBack={goBack} handleNext={handleNext} />
              )}
            </div>
          )}
        </Box>
