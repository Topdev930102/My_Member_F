...
const Myemplyee = (props) => {
  ...
  }, [GET_EMPLOYEE_ROLES_LIST, GET_ROLE_LIST_USERS_INFO]);
      ...
      <Row className="mb-1">
        <Col sm="12" md="12" lg="12">
          <div className="d-flex justify-content-between">
            <FormGroup>
              <Select onChange={selectRoleHandler} style={{ width: "200px" }}>
            ...
            <div>
              <Button
                className="primary addCreateButton"
                onClick={() => history.push("/app/my-employee/Create/0")}
              >
                Add Employee
              </Button>
            </div>
                ...
                >
                  <TableCell component="th" scope="row">
                    <div className="d-flex ">
                      ...
                      <Link
                        to={{
                          pathname: `/app/my-employee/Edit/${item?._id}`,
                          state: { ...item },
                        }}
                        className="d-flex align-items-center"
                      >
                        <Typography className="mb-0 d-flex align-items-center ml-1">
