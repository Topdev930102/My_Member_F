...
function MessageButton() {
  ...
  return (
    <div className={`max-w-full absolute bottom-[20px] z-10 flex items-end will-change-auto p-1 right-[20px] justify-end bg-transparent cursor-pointer`}>
      <div className="flex min-w-0">
        {style === "bubble" ? (
          <div
            className={`flex w-[60px] h-[60px] rounded-full justify-center ml-auto relative `}
            style={{ boxShadow: "0 4px 12px rgba(0,0,0,0.3)", backgroundColor: themeColor }}
          >
            <button
              type="button"
          ...
          <div className={`w-[320px] h-[40px] rounded-t-md text-white font-[600] px-[0.9em]`} style={{backgroundColor: themeColor}}>
...
function MessageWindow({ hideWindow }) {
  ...
  return (
    <div
      className={
        `absolute h-[640px] w-[320px] m-2 bottom-[20px] right-[20px] ` + darkmode
      }
    >
      <div className={`relative flex flex-col min-w-0 h-full w-full  overflow-hidden rounded-lg text-gray-100`} style={{backgroundColor: themeColor}}>
        <div className="justify-between w-full relative h-[56px] shrink-0 overflow-hidden flex-grow-0 flex flex-row items-center ">
          ...
          <div className="flex flex-row">
            <IconButton sx={{color: 'white'}} aria-label="delete" onClick={(e) => hideWindow()}>
              <Minimize />
            </IconButton>
...
const UserRegister = (props) => {
  ...
  const themeColor = useTheme().status.themeColor;


  return (
    <div className=" m-[8px] mt-[21px] flex flex-col items-center rounded-[6px] bg-[#ffffff] p-[16px] dark:bg-gray-700 text-[#111111] dark:text-gray-100">
         <PersonOutline
          sx={{ width: "42px", height: "42px" }}
          className="mt-[-37px] rounded-full text-white p-[5px]"
      ...
      >
        ...
        <div className="flex flex-col items-start text-[14px] pb-[8px] w-full">
          ...
          {isSubmitted ? (
            ...
            <input
              ref={nameRef}
              className="w-full border-[1px] border-solid outline-none border-[#757575] appearance-none text-black bg-[#f8f8f8] shadow-none rounded-[6px] text-[0.875rem] p-2 mx-[2px] focus:border-[#2000f0] focus:bg-white"
              style={{
                transition:
        ...
        {isSubmitted ? null : (
          <Button variant="contained" className="text-white" fullWidth type="submit">
            Start Chat
          </Button>
        )}
      </form>
...
const MessageInputGroup = (props) => {
  ...
  return (
    <div>
      ...
      >
        <div className="relative flex flex-row items-center text-[#111111] dark:text-gray-100">
          <input
            ref={messageRef}
          ...
          <div className="absolute right-[1rem] text-[#111111] dark:text-gray-100">
            <button onClick={(e) => console.log("emoji")} disabled={props.disabled}>
              <EmojiEmotionsOutlined />
            </button>
            <button onClick={(e) => console.log("attach")} disabled={props.disabled}>
              <AttachFile />
            </button>
