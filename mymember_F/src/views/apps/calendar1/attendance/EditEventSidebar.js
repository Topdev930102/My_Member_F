      ...
      >
          ...
          <form onSubmit={this.handleSubmit}>
            <div className="d-flex justify-content-between mb-1 p-1">
              <div>
                ...
                <Typography className="my-0">
                  {`${moment(
                    this.props.calendar?.classStudentList[0]?.start_time
                  ).format("hh:mm A")} - ${moment(
                    this.props.eventInfo?.end_time
                  ).format("hh:mm A")}`}
                </Typography>
              </div>
        ...
        <Card style={{ boxShadow: "none", padding: "1em", height: "600px" }}>
          <CardBody className="cd-body-rm pd-body">
            <Table key="Attendance-list" style={{ overflow: "auto" }}>
          ...
          <ConfirmationModal
            ...
            open={this.state.sweetAlertOpen}
            title="Are you sure?"
