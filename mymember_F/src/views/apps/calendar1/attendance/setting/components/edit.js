            ...
            <FormGroup>
              ...
              {event?.program_name !== "" ? (
                ...
                >
                  {programList?.map((item, index) => {
                    return (
                      <option key={index} value={item?.programName}>
                        {item.programName}
                      </option>
                    );
                  })}
              ...
              repeat_weekly_on?.map((item, i) => {
                return (
                  <Chip
                    ...
                    size="small"
                    icon={
                      <CheckCircleOutlineIcon style={{ color: "#4f7fff" }} />
                    }
                    ...
                    style={{
                      margin: "4px",
                      background:
                        getDayName(event?.start_date).toLocaleLowerCase() ===
                        item
                          ? "#6610f21a"
                          : "#f8f8f8",
                      color: "#4f7fff",
