...
const calendarReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case "HANDLE_SETTING_SIDEBAR":
      return { ...state, settingSidebar: action.status };
    case "HANDLE_EDIT_SETTING_SIDEBAR":
      return { ...state, editSettingSidebar: action.status };
