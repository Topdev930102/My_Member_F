...
export const ExpenseCategoryList = () => {
  return async (dispatch) => {
    try {
      let response = await axios.get(
        `${baseUrl}/api/expenses/list_category/${getUserId()}`,
        {
          headers: getHeaders(),
        }
      );
...
export const GetMonthlyPaymentList = () => {
  return async (dispatch) => {
    try {
      let response = await axios.get(
        `${baseUrl}/api/finance/monthly_pay_list/${getUserId()}`,
        {
          headers: getHeaders(),
        }
      );
...
export const ExpenseBreakDownList = () => {
  return async (dispatch) => {
    try {
      let response = await axios.get(
        `${baseUrl}/api/finance/expense_breakdown/${getUserId()}`,
        {
          headers: getHeaders(),
        }
      );
...
export const SENT_EMAIL_COMPOSE = (task) => {
  return async (dispatch) => {
    let response = await axios.post(
      `${baseUrl}/api/email_compose/send_email/${localStorage.getItem(
        "user_id"
      )}`,
      { ...task },
      {
...
export const moveMail = (id) => {
  return (dispatch) => {
    axios
      .delete(
        `${baseUrl}/api/email_compose/remove_template/${getUserId()}/${id}`,
        {
          headers: getHeaders(),
        }
      )
...
export const GetFolderList = () => {
  return async (dispatch) => {
    try {
      let response = await axios.get(
        `${baseUrl}/api/email_compose/category_list/${getUserId()}`,
        {
          headers: getHeaders(),
        }
      );
...
export const fetchAllCCAction = (page, perPage) => {
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/fetch-all-cc/${getUserId()}`,
        {
          params: {
            page,
            perPage,
...
export const getExpenseByCategoryAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/expense-state/${getUserId()}`,
        {
          headers: getHeaders(),
        }
      );
...
export const getTodaysExpenseAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/expense-today/${getUserId()}`,
        {
          headers: getHeaders(),
        }
      );
...
export const getWeeklyExpenseAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/expense-weekly/${getUserId()}`,
        {
          headers: getHeaders(),
        }
      );
...
export const getMonthlyExpenseAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/expense-monthly/${getUserId()}`,
        {
          headers: getHeaders(),
        }
      );
...
export const getYearlyExpenseAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/expense-yearly/${getUserId()}`,
        {
          headers: getHeaders(),
        }
      );
...
export const getExpenseReportFilterAction = (
  paymentSystem,
  month,
  year,
  page
  ...
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/expense-report/${getUserId()}`,
        {
          params: {
            paymentSystem,
            month,
  ...
  return async (dispatch) => {
    try {
      ...
      if (response.data && response.status === 200) {
        ...
        dispatch(
          getExpenseReportFilterAction(paymentSystem, month, year, page)
        );
        dispatch(getExpenseByCategoryAction());
        dispatch(getExpenseMonthlyComopareAction());
        dispatch(getTodaysExpenseAction());
...
export const getTodaysIncomeAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/income-today/${getUserId()}`,
        {
          headers: getHeaders(),
        }
      );
...
export const getWeeklyIncomeAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/income-weekly/${getUserId()}`,
        {
          headers: getHeaders(),
        }
      );
...
export const getMonthlyIncomeAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/income-monthly/${getUserId()}`,
        {
          headers: getHeaders(),
        }
      );
...
export const onTimeExpenseRequest = (expenseType) => {
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/expense-by-type/${getUserId()}`,
        {
          params: {
            type: expenseType,
          },
...
export const getYearlyIncomeAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/income-yearly/${getUserId()}`,
        {
          headers: getHeaders(),
        }
      );
...
export const getIncomeReportFilterAction = (paymentSystem, month, year) => {
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/income-report/${getUserId()}`,
        {
          params: {
            paymentSystem,
            month,
...
export const filterDataForPNLExpenseAction = (payload) => {
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/pnl-expense-report/${getUserId()}`,
        {
          params: { ...payload },
          headers: getHeaders(),
        }
...
export const deleteCategoryAction = ({ id }) => {
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/category-delete/${getUserId()}`,
        {
          params: {
            id,
          },
...
export const getLastMonthExpenseAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await axios.get(
        `${baseUrl}/api/finance/last-month-expense/${getUserId()}`,
        {
          headers: getHeaders(),
        }
      );
...
export const ADD_INVOICE = (payload) => {
  let url = `${baseUrl}/api/finance/finance_invoice/${getUserId()}`;
  return async () => {
    try {
