...
export const handleSettingSidebar = (bool) => {
  return (dispatch) =>
    dispatch({ type: "HANDLE_SETTING_SIDEBAR", status: bool });
};

export const handleEditSettingSidebar = (bool) => {
  return (dispatch) =>
    dispatch({ type: "HANDLE_EDIT_SETTING_SIDEBAR", status: bool });
};
